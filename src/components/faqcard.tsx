...
export default function FaqCard(props:{indx:String,question:string,answer:string}){
    return <div
        className="backdrop-blur-sm flex flex-col  min-h-[30vh] h-auto pb-5 md:pb-0 md:h-[60vh] rounded-xl opacity-100 bg-white bg-opacity-10 mt-10 mx-5  md:w-[21vw] border-main-blue border-8">

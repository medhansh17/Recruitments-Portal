export default function Hero(){
    return (
        <section className="flex flex-col items-center justify-center h-screen w-screen border-red-600 border-2 text-white pt-10">
            <div className="flex flex-col items-center justify-center font-striger my-10">
                ...
                <div className="flex flex-row items-center justify-center">
                    ...
                    <h2 className="text-2xl md:text-4xl text-center text-white mx-5 font-sarpanch font-bold">IN THE</h2>

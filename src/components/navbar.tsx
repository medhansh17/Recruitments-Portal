...
export default function Nav(){
    ...
    <nav className={`flex flex-row justify-center items-center fixed py-5 w-full `}>
        ...
        <ul className={` ${pathname==='/login'?'hidden md:hidden':' hidden md:flex'} flex-row justify-center items-center font-striger px-4 py-2 bg-main-grey bg-opacity-40 rounded-full`}>
